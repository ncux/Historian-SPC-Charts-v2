    ...
    this.chart = new Chart(this.ctx, {
      ...
      data: {
        ...
        datasets: [
          {
            label: this.tagName,
            data: this.chartDataService.numberValuesArray,  //  (measured) tag values
            borderColor: '#000000',
            fill: false
          },
          {
            label: 'MEAN',
            data: this.chartDataService.MeanArray,   // mean
            borderColor: '#008000',
            fill: false
          }
          ,
          {
            label: 'UCL',
            data: this.chartDataService.UCLarray,  // UCL
            borderColor: '#FF0000',
            fill: false
          }
          ,
          {
            label: 'LCL',
            data: this.chartDataService.LCLarray,   // LCL
            borderColor: '#4169E1',
            fill: false
          }
        ]
